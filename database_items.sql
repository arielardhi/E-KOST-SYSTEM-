...
(1, 'Ranjang Kayu Jati Single Bekas', 'Ranjang kayu jati bekas kondisi sangat baik. Kokoh dan tahan lama. Harga terjangkau.', 350000, 2, 'Bekas - Sangat Baik', 5, 'Surabaya', 'Jl. Dharmawangsa No. 56', 4.6, 6, 'tersedia'),
...
(2, 'Lemari Plastik 3 Pintu Bekas', 'Lemari plastik bekas kondisi baik. Ringan dan mudah dipindahkan. Cocok untuk barang-barang kecil.', 200000, 3, 'Bekas - Baik', 5, 'Surabaya', 'Jl. Dharmawangsa No. 56', 4.1, 4, 'tersedia'),
...
(3, 'Kursi Plastik Bekas Kondisi Baik', 'Kursi plastik bekas, masih kokoh dan nyaman. Harga sangat terjangkau untuk mahasiswa.', 80000, 6, 'Bekas - Baik', 5, 'Surabaya', 'Jl. Dharmawangsa No. 56', 4.0, 3, 'tersedia'),
...
(4, 'Peralatan Masak Set Lengkap', 'Set peralatan masak lengkap berisi sendok, garpu, pisau, talenan, dan lainnya. Praktis.', 200000, 6, 'Baru', 5, 'Surabaya', 'Jl. Dharmawangsa No. 56', 4.2, 5, 'tersedia'),
...
(5, 'Microwave 20 Liter', 'Microwave 20 liter untuk memanaskan makanan. Mudah digunakan dan hemat tempat.', 450000, 3, 'Baru', 5, 'Surabaya', 'Jl. Dharmawangsa No. 56', 4.5, 9, 'tersedia'),
...
(6, 'Lampu Neon Flex RGB 5 Meter', 'Lampu neon flex RGB yang dapat berubah warna. Cocok untuk dekorasi kamar kos modern.', 250000, 4, 'Baru', 5, 'Surabaya', 'Jl. Dharmawangsa No. 56', 4.5, 8, 'tersedia'),
...
(7, 'Poster Motivasi Set 4 Buah', 'Set 4 poster motivasi dengan desain menarik. Cocok untuk dekorasi dinding kamar kos.', 80000, 15, 'Baru', 5, 'Surabaya', 'Jl. Dharmawangsa No. 56', 4.4, 5, 'tersedia'),
...
(8, 'Sabun Pembersih Lantai 1 Liter', 'Sabun pembersih lantai yang efektif membunuh kuman. Wangi segar dan hemat pemakaian.', 25000, 25, 'Baru', 5, 'Surabaya', 'Jl. Dharmawangsa No. 56', 4.4, 7, 'tersedia'),
...
(9, 'Wastafel Keramik Putih', 'Wastafel keramik putih dengan desain modern. Cocok untuk kamar mandi kos.', 280000, 4, 'Baru', 5, 'Surabaya', 'Jl. Dharmawangsa No. 56', 4.3, 5, 'tersedia'),
...
(10, 'Jam Dinding Digital LED', 'Jam dinding digital LED dengan tampilan besar. Cocok untuk kamar kos modern.', 85000, 8, 'Baru', 5, 'Surabaya', 'Jl. Dharmawangsa No. 56', 4.3, 4, 'tersedia'),
