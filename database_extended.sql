...
('hendra_owner',  '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'hendra@owner.com',  'owner', 'Hendra Kusuma',   '086789012345'),
('lisa_owner',    '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'lisa@owner.com',    'owner', 'Lisa Permata',    '087890123456'),
('wahyu_owner',   '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'wahyu@owner.com',   'owner', 'Wahyu Pratama',   '088901234567'),
('maya_owner',    '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'maya@owner.com',    'owner', 'Maya Sari',       '089012345678'),
('fajar_owner',   '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'fajar@owner.com',   'owner', 'Fajar Nugroho',   '081122334455'),
('nita_owner',    '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'nita@owner.com',    'owner', 'Nita Wulandari',  '082233445566'),
('dimas_owner',   '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'dimas@owner.com',   'owner', 'Dimas Aditya',    '083344556677'),
('rina_owner',    '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'rina@owner.com',    'owner', 'Rina Mahardika',  '084455667788');

-- ── Sample Users (tenant / pencari kost) ────────────────────
INSERT INTO users (username, password, email, role, full_name, phone) VALUES
('andi_user',  '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'andi@user.com',  'user', 'Andi Saputra',   '085111222333'),
('citra_user', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'citra@user.com', 'user', 'Citra Dewi',     '085222333444'),
('bayu_user',  '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'bayu@user.com',  'user', 'Bayu Ramadan',   '085333444555'),
('sinta_user', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'sinta@user.com', 'user', 'Sinta Amalia',   '085444555666'),
('rio_user',   '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'rio@user.com',   'user', 'Rio Ferdiansyah','085555666777');

-- ── 22 Kost Baru di Berbagai Kota ───────────────────────────
-- (owner_id 7–14 adalah owner baru di atas; 2–6 owner lama)
INSERT INTO kost (owner_id, name, type, description, address, city, latitude, longitude, facilities, rules) VALUES

-- ── YOGYAKARTA (7 kost) ──────────────────────────────────────
(7,  'Kost Premium UGM Garden', 'Putri',
...
(7,  'Kost Prawirotaman Artistik', 'Campur',
...
(8,  'Kost Kotagede Heritage', 'Putra',
...
(8,  'Kost Condongcatur Techno', 'Campur',
...
(10, 'Kost Wates Kulonprogo', 'Putra',
...
-- ── BANDUNG (4 kost) ─────────────────────────────────────────
(10, 'Kost Dago Pakar Hijau', 'Putri',
...
(11, 'Kost Buah Batu Strategis', 'Campur',
...
(12, 'Kost Setrasari Premium', 'Campur',
...
-- ── JAKARTA (4 kost) ─────────────────────────────────────────
(12, 'Kost Kemang Eksekutif', 'Campur',
...
(13, 'Kost Kelapa Gading Modern', 'Campur',
...
(14, 'Kost Bekasi Timur Permai', 'Putra',
...
-- ── SURABAYA (3 kost) ────────────────────────────────────────
(14, 'Kost Rungkut Industri', 'Putra',
...
(8,  'Kost Citraland Residence', 'Campur',
...
-- ── MALANG (2 kost) ──────────────────────────────────────────
(11, 'Kost Soekarno Hatta Malang', 'Campur',
...
(12, 'Kost Batu Apple House', 'Putri',
...
-- Kost lama 1-10
(15, 1, 5, 'Kost terbaik di Yogya! Bersih, aman, dan penjagaannya ketat. Sangat direkomendasikan untuk mahasiswi UGM.'),
(16, 1, 4, 'Lokasi sangat strategis, hanya 10 menit ke kampus. Fasilitas lengkap meski harga agak tinggi.'),
(17, 2, 4, 'Kost Mawar sangat nyaman untuk mahasiswa. Dekat Malioboro dan stasiun, harga terjangkau banget!'),
(15, 3, 5, 'Harmoni Jaya terbaik! Gym dan rooftop-nya seru banget. Wifi kencang, cocok untuk work from home.'),
(18, 4, 4, 'Kost di Lembang sejuk banget udaranya. Wajib bawa jaket tapi worth it! Lingkungan nyaman.'),
(19, 5, 5, 'Grand Jakarta is premium! Worth the price. Kolam renang dan gym bikin hidup makin sehat.'),
(16, 6, 3, 'Harga terjangkau, lokasi oke dekat UI. Tapi kamar mandi luar jadi kurang privasi.'),
(17, 7, 4, 'Kost Surabaya Asri enak, tenang dan bersih. AC dingin, recommended untuk yang kerja di RSUD.'),
(18, 8, 5, 'Kost Semarang paling oke! Di Simpang Lima, gampang ke mana-mana. Pemilik juga ramah.'),
(19, 9, 4, 'Amikom Residence pas banget untuk mahasiswa IT. Wifi cepat, suasana belajar kondusif.'),
(15, 10, 3, 'Kost Malang cukup oke untuk harga segitu. Fasilitas standar tapi bersih dan aman.'),
-- Kost baru 11-32
(16, 11, 5, 'UGM Garden luar biasa! Taman cantik, ruang baca nyaman, komunitas belajarnya aktif banget.'),
(17, 11, 4, 'Kost premium yang worth it. Dekat UGM, fasilitas lengkap. Hanya agak mahal tapi sebanding.'),
(18, 12, 5, 'Prawirotaman vibes-nya keren banget! Desain artistik, dekat kafe dan galeri seni Yogya.'),
(19, 13, 3, 'Kost sederhana tapi bersih. Lokasi Kotagede unik, ada nuansa heritage Jawa. Harga murah!'),
(15, 14, 5, 'Techno banget! Wifi 100 Mbps beneran kencang, co-working space nyaman. Cocok untuk developer.'),
(16, 15, 4, 'Bantul Permai tenang banget, cocok yang suka suasana pedesaan. Dekat ISI Yogya.'),
(17, 16, 5, 'Seturan Elite setara apartemen! Gym dan kolam renang available. Worth the price banget!'),
(18, 18, 5, 'Dago Pakar pemandangannya indah banget. Sejuk, bersih, dan aman. Rekomendasi untuk putri!'),
(19, 19, 4, 'Buah Batu strategis banget. Ke mana-mana gampang. Fasilitas lengkap dengan harga wajar.'),
(15, 22, 5, 'Kemang Eksekutif mewah! Cocok untuk expat dan startup founder. Rooftop view Jakarta!'),
(16, 23, 5, 'Kelapa Gading premium abis. Concierge, kolam renang, dekat mall. Gaya hidup level up!'),
(17, 24, 4, 'Tebet Cozy nyaman banget, dekat Eco Park. Sering jalan kaki pagi ke taman. Worth it!'),
(18, 29, 4, 'Tembalang Undip strategis banget untuk mahasiswa Undip. Wifi cepat, kamar bersih.'),
(19, 31, 4, 'Soekarno Hatta Malang posisinya oke, banyak warung makan dan kafe dekat sini.');

-- ══════════════════════════════════════════════════════════════
-- BOOKING SAMPLE
-- ══════════════════════════════════════════════════════════════
INSERT INTO booking (user_id, kamar_id, start_date, duration_months, total_price, status) VALUES
(15, 1,  '2025-01-01', 6,  4800000, 'confirmed'),
(16, 5,  '2025-02-01', 12, 18000000,'confirmed'),
(17, 10, '2025-01-15', 3,  3600000, 'completed'),
(18, 12, '2025-03-01', 6,  6000000, 'confirmed'),
(19, 16, '2025-02-15', 12, 24000000,'confirmed'),
(15, 20, '2025-04-01', 3,  2100000, 'confirmed'),
(16, 24, '2025-03-01', 6,  8100000, 'confirmed'),
(17, 30, '2025-01-01', 12, 13200000,'completed'),
(18, 35, '2025-05-01', 6,  5100000, 'pending'),
(19, 40, '2025-04-15', 3,  3000000, 'confirmed');
